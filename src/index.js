...
function makePipe(pipePos) {
  ...
  let tolalWidth = gameArea.offsetWidth;
  ...
  pipeUp.style.left = tolalWidth + pipePos + "px";
  pipeUp.x = tolalWidth + pipePos;
  ...
  pipeDown.style.left = tolalWidth + pipePos + "px";
  pipeDown.x = tolalWidth + pipePos;
